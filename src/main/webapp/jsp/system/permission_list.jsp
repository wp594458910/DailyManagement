            ...
            <div class="main-right  col-md-10 col-md-offset-2">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading">permission列表</div>
                        
                        <div class="panel-body">
                        	<div class="main-right  col-xs-12">
                        		<div class="pull-right" >
                        			<a class="btn btn-success" href="<%=path%>/jsp/permission_add.jsp"><font color="#FFFFFF">新增permission</font></a>
                        		</div>
                        	</div>
                                ...
                                <tbody>
                                	<c:forEach items="${permissionList}" var="item">
	                                    <tr>
											...
											<a href="<%=path %>/editPermission.do?id=${item.id}"}"><i class="glyphicon glyphicon-edit"></i></a>
											<a href="<%=path %>/deletePermissionByid.do?id=${item.id}" onclick="return confirm('确定删除吗?')"><i class="glyphicon glyphicon-remove"></i></a>
	                                        </td> 
	                                    </tr>
                                   </c:forEach>
                                </tbody>
							...
							<div class="pull-right">
								<nav>
									<ul class="pagination">
										...
										<c:if test="${page.pageNumber!=1 && page.totalPage!=0 }">
											<li><a href="<%=path %>/queryPermissionBypage.do?pageNumber=1">首页</a></li>
											<li><a href="<%=path %>/queryPermissionBypage.do?pageNumber=${page.pageNumber-1 }">上一页 </a></li>
										</c:if>
										...
										<c:if test="${page.pageNumber!=page.totalPage && page.totalPage!=0 }">
											<li><a href="<%=path %>/queryPermissionBypage.do?pageNumber=${page.pageNumber+1 }">下一页 </a></li>
											<li><a href="<%=path %>/queryPermissionBypage.do?pageNumber=${page.totalPage }">尾页</a></li>
										</c:if>
									</ul>
								</nav>
							</div>
