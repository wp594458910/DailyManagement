        ...
        <div class="row" style="margin-top:70px">
            ...
            <div class="main-right  col-md-10 col-md-offset-2">
                <div class="panel-body">
                    <ol class="breadcrumb">
                        <li><a href="#">首页</a></li>
                        <li><a href="#">编辑rolePermission</a></li>
                    </ol>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading">编辑rolePermission</div>
                        
                        <div class="panel-body">
                        	<div class="main  col-xs-12">
                        	<form action="<%=path %>/updateRolePermission.do" method="post">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">roleid</label>
                                    <input type="text" name="roleid" value="${rolePermission.roleid}" class="form-control" placeholder="roleid" />
                                </div>
								<input type="hidden" value="${rolePermission.permissionid}" name="permissionid">
