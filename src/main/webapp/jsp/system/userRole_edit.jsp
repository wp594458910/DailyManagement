            ...
            <div class="main-right  col-md-10 col-md-offset-2">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading">编辑userRole</div>
                        
                        <div class="panel-body">
                        	<div class="main  col-xs-12">
                        	<form action="<%=path %>/updateUserRole.do" method="post">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">userid</label>
                                    <input type="text" name="userid" value="${userRole.userid}" class="form-control" placeholder="userid" />
                                </div>
								<input type="hidden" value="${userRole.roleid}" name="roleid">
