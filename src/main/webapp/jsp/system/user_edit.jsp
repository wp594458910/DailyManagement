            ...
            <div class="main-right  col-md-10 col-md-offset-2">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading">编辑user</div>
                        ...
                        <div class="panel-body">
                        	...
                        	<form action="<%=path %>/updateUser.do" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salt" value="${user.salt}" class="form-control" placeholder="salt" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">locked</label>
                                    <input type="text" name="locked" value="${user.locked}" class="form-control" placeholder="locked" />
                                </div>
